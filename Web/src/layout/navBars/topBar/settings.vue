				...
				<div class="layout-breadcrumb-seting-bar-flex mt15">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-select v-model="getThemeConfig.animation" placeholder="请选择" size="small" style="width: 90px; margin-right: 1px" @change="setLocalThemeConfig">
							<el-option :label="$t('message.layout.fiveAnimationOptions.slideRight')" value="slide-right"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.slideLeft')" value="slide-left"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.opacitys')" value="opacitys"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.fade')" value="fade"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.fadeUp')" value="fadeUp"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.fadeDown')" value="fadeDown"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.fadeLeft')" value="fadeLeft"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.fadeRight')" value="fadeRight"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.lightSpeedLeft')" value="lightSpeedLeft"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.lightSpeedRight')" value="lightSpeedRight"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.zoom')" value="zoom"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.zoomUp')" value="zoomUp"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.zoomDown')" value="zoomDown"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.zoomLeft')" value="zoomLeft"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.zoomRight')" value="zoomRight"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.flip')" value="flip"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.flipX')" value="flipX"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.flipY')" value="flipY"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.backUp')" value="backUp"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.backDown')" value="backDown"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.backLeft')" value="backLeft"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.backRight')" value="backRight"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.bounce')" value="bounce"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.bounceUp')" value="bounceUp"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.bounceDown')" value="bounceDown"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.bounceLeft')" value="bounceLeft"></el-option>
							<el-option :label="$t('message.layout.fiveAnimationOptions.bounceRight')" value="bounceRight"></el-option>
						</el-select>
					</div>
				</div>
